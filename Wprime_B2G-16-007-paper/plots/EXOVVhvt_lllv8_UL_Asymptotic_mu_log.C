...
//=========  (Fri Oct 21 12:46:57 2016) by ROOT version5.34/18
   ...
   c_lim_Asymptotic->Range(0.53875,-2.592593,2.16375,2.345679);
   ...
   TH1F *hframe__4 = new TH1F("hframe__4","",1000,0.75,2.05);
   ...
   grae->SetPoint(0,0.8,0.08940601);
   grae->SetPointError(0,0,0,0,0);
   grae->SetPoint(1,0.9,0.09110717);
   grae->SetPointError(1,0,0,0,0);
   grae->SetPoint(2,1,0.08823395);
   grae->SetPointError(2,0,0,0,0);
   grae->SetPoint(3,1.1,0.09497833);
   grae->SetPointError(3,0,0,0,0);
   grae->SetPoint(4,1.2,0.138576);
   grae->SetPointError(4,0,0,0,0);
   grae->SetPoint(5,1.3,0.171783);
   grae->SetPointError(5,0,0,0,0);
   grae->SetPoint(6,1.4,0.2410936);
   grae->SetPointError(6,0,0,0,0);
   grae->SetPoint(7,1.5,0.3300905);
   grae->SetPointError(7,0,0,0,0);
   grae->SetPoint(8,1.6,0.4951215);
   grae->SetPointError(8,0,0,0,0);
   grae->SetPoint(9,1.7,0.6672907);
   grae->SetPointError(9,0,0,0,0);
   grae->SetPoint(10,1.8,0.8999205);
   grae->SetPointError(10,0,0,0,0);
   grae->SetPoint(11,1.9,1.23064);
   grae->SetPointError(11,0,0,0,0);
   grae->SetPoint(12,2,1.69806);
   grae->SetPointError(12,0,0,0,0);
   grae->SetPoint(13,2,13.27521);
   grae->SetPointError(13,0,0,0,0);
   grae->SetPoint(14,1.9,9.438064);
   grae->SetPointError(14,0,0,0,0);
   grae->SetPoint(15,1.8,6.412884);
   grae->SetPointError(15,0,0,0,0);
   grae->SetPoint(16,1.7,4.597321);
   grae->SetPointError(16,0,0,0,0);
   grae->SetPoint(17,1.6,3.269552);
   grae->SetPointError(17,0,0,0,0);
   grae->SetPoint(18,1.5,2.239478);
   grae->SetPointError(18,0,0,0,0);
   grae->SetPoint(19,1.4,1.580095);
   grae->SetPointError(19,0,0,0,0);
   grae->SetPoint(20,1.3,1.105756);
   grae->SetPointError(20,0,0,0,0);
   grae->SetPoint(21,1.2,0.877094);
   grae->SetPointError(21,0,0,0,0);
   grae->SetPoint(22,1.1,0.640176);
   grae->SetPointError(22,0,0,0,0);
   grae->SetPoint(23,1,0.5295763);
   grae->SetPointError(23,0,0,0,0);
   grae->SetPoint(24,0.9,0.4864646);
   grae->SetPointError(24,0,0,0,0);
   grae->SetPoint(25,0.8,0.4531748);
   grae->SetPointError(25,0,0,0,0);
   
   TH1F *Graph_Limit95CLs5 = new TH1F("Graph_Limit95CLs5","Graph",100,0.68,2.12);
   Graph_Limit95CLs5->SetMinimum(0.07941055);
   Graph_Limit95CLs5->SetMaximum(14.59391);
   ...
   grae->SetLineWidth(3);
   grae->SetMarkerStyle(20);
   grae->SetPoint(0,0.8,0.1251432);
   grae->SetPointError(0,0,0,0,0);
   grae->SetPoint(1,0.9,0.128982);
   grae->SetPointError(1,0,0,0,0);
   grae->SetPoint(2,1,0.128241);
   grae->SetPointError(2,0,0,0,0);
   grae->SetPoint(3,1.1,0.1410239);
   grae->SetPointError(3,0,0,0,0);
   grae->SetPoint(4,1.2,0.2020125);
   grae->SetPointError(4,0,0,0,0);
   grae->SetPoint(5,1.3,0.2498887);
   grae->SetPointError(5,0,0,0,0);
   grae->SetPoint(6,1.4,0.3524788);
   grae->SetPointError(6,0,0,0,0);
   grae->SetPoint(7,1.5,0.4875627);
   grae->SetPointError(7,0,0,0,0);
   grae->SetPoint(8,1.6,0.7238674);
   grae->SetPointError(8,0,0,0,0);
   grae->SetPoint(9,1.7,0.9856268);
   grae->SetPointError(9,0,0,0,0);
   grae->SetPoint(10,1.8,1.343304);
   grae->SetPointError(10,0,0,0,0);
   grae->SetPoint(11,1.9,1.86287);
   grae->SetPointError(11,0,0,0,0);
   grae->SetPoint(12,2,2.588509);
   grae->SetPointError(12,0,0,0,0);
   grae->SetPoint(13,2,7.766812);
   grae->SetPointError(13,0,0,0,0);
   grae->SetPoint(14,1.9,5.508874);
   grae->SetPointError(14,0,0,0,0);
   grae->SetPoint(15,1.8,3.839082);
   grae->SetPointError(15,0,0,0,0);
   grae->SetPoint(16,1.7,2.767644);
   grae->SetPointError(16,0,0,0,0);
   grae->SetPoint(17,1.6,1.978452);
   grae->SetPointError(17,0,0,0,0);
   grae->SetPoint(18,1.5,1.356427);
   grae->SetPointError(18,0,0,0,0);
   grae->SetPoint(19,1.4,0.9633842);
   grae->SetPointError(19,0,0,0,0);
   grae->SetPoint(20,1.3,0.6737541);
   grae->SetPointError(20,0,0,0,0);
   grae->SetPoint(21,1.2,0.5385937);
   grae->SetPointError(21,0,0,0,0);
   grae->SetPoint(22,1.1,0.3903153);
   grae->SetPointError(22,0,0,0,0);
   grae->SetPoint(23,1,0.3304335);
   grae->SetPointError(23,0,0,0,0);
   grae->SetPoint(24,0.9,0.3134726);
   grae->SetPointError(24,0,0,0,0);
   grae->SetPoint(25,0.8,0.2982088);
   grae->SetPointError(25,0,0,0,0);
   
   TH1F *Graph_Limit68CLs6 = new TH1F("Graph_Limit68CLs6","Graph",100,0.68,2.12);
   Graph_Limit68CLs6->SetMinimum(0.1126289);
   Graph_Limit68CLs6->SetMaximum(8.530979);
   ...
   TH1F *Graph_LimitExpectedCLs7 = new TH1F("Graph_LimitExpectedCLs7","Graph",100,0.68,2.12);
   Graph_LimitExpectedCLs7->SetMinimum(0.1709473);
   Graph_LimitExpectedCLs7->SetMaximum(4.798877);
   ...
   TH1F *Graph_LimitObservedCLs8 = new TH1F("Graph_LimitObservedCLs8","Graph",100,0.68,2.12);
   Graph_LimitObservedCLs8->SetMinimum(0.1179768);
   Graph_LimitObservedCLs8->SetMaximum(3.827714);
   ...
   TH1F *Graph_CrossSectionTheo2 = new TH1F("Graph_CrossSectionTheo2","Graph",100,0.68,2.12);
...
tex->SetNDC();
   ...
   TH1F *hframe__5 = new TH1F("hframe__5","",1000,0.75,2.05);
   ...
   TH1F *hframe__6 = new TH1F("hframe__6","",1000,0.75,2.05);
