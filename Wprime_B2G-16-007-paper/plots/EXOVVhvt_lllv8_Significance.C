...
//=========  (Fri Oct 21 12:46:20 2016) by ROOT version5.34/18
   ...
   c_Significance->Range(0.30625,-5.888889,2.18125,1.518519);
   ...
   TH1F *Graph_Expected3 = new TH1F("Graph_Expected3","Graph",100,0.46,2.14);
   Graph_Expected3->SetMinimum(6.75905e-32);
   Graph_Expected3->SetMaximum(0.2136629);
   ...
   TH1F *Graph_Observed4 = new TH1F("Graph_Observed4","Graph",100,0.46,2.14);
   Graph_Observed4->SetMinimum(0.04824772);
   Graph_Observed4->SetMaximum(0.5410684);
