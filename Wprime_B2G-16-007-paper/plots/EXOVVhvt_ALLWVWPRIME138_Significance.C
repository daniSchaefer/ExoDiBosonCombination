...
//=========  (Fri Oct 21 12:46:03 2016) by ROOT version5.34/18
   ...
   Graph_Expected1->SetMaximum(0.3001395);
   ...
   Graph_Observed2->SetMinimum(0.005184239);
   Graph_Observed2->SetMaximum(0.549424);
