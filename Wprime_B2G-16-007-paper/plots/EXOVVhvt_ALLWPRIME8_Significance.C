...
//=========  (Fri Oct 21 12:46:15 2016) by ROOT version5.34/18
   ...
   Graph_Expected1->SetMinimum(1.800031e-43);
   Graph_Expected1->SetMaximum(0.504774);
   ...
   Graph_Observed2->SetMinimum(0.01072702);
   Graph_Observed2->SetMaximum(0.5488081);
