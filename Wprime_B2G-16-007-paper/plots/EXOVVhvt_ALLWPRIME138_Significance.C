...
//=========  (Fri Oct 21 12:46:19 2016) by ROOT version5.34/18
   ...
   Graph_Expected1->SetMaximum(0.2860705);
   ...
   Graph_Observed2->SetMinimum(0.003477671);
   Graph_Observed2->SetMaximum(0.5496136);
