...
def plot_Asympt_limits(label,mainLabel):
 ...
 for m in mass:
   ...
   if m>=800:
    ...
    scaleB['ALLWVWPRIME8'][m] = 1
    scaleB['ALLHVWPRIME8'][m] = 1
    scaleB['ALLWPRIME8'][m] = 1
    scaleB['JJLVJWPRIME13'][m] = (xsecMap13['CX-(pb)'][idx]+xsecMap13['CX+(pb)'][idx])*(xsecMap13['BRZW'][idx]+xsecMap13['BRWh'][idx])
    ...
    if m <= 3000:
     ...
     scaleB['ALLWVWPRIME8'][m] = (xsecMap8['CX-(pb)'][idx2]+xsecMap8['CX+(pb)'][idx2])*(xsecMap8['BRZW'][idx2]+xsecMap8['BRWh'][idx2])
     scaleB['ALLHVWPRIME8'][m] = (xsecMap8['CX-(pb)'][idx2]+xsecMap8['CX+(pb)'][idx2])*(xsecMap8['BRZW'][idx2]+xsecMap8['BRWh'][idx2])
     scaleB['ALLWPRIME8'][m]   = (xsecMap8['CX-(pb)'][idx2]+xsecMap8['CX+(pb)'][idx2])*(xsecMap8['BRZW'][idx2]+xsecMap8['BRWh'][idx2])
   else:
   ...
   scaleA['ALLWVWPRIME8'][m] = (xsecMap8A['CX-(pb)'][idxA]+xsecMap8A['CX+(pb)'][idxA])*(xsecMap8A['BRZW'][idxA]+xsecMap8A['BRWh'][idxA])
   scaleA['ALLHVWPRIME8'][m] = (xsecMap8A['CX-(pb)'][idxA]+xsecMap8A['CX+(pb)'][idxA])*(xsecMap8A['BRZW'][idxA]+xsecMap8A['BRWh'][idxA])
   scaleA['ALLWPRIME8'][m] = (xsecMap8A['CX-(pb)'][idxA]+xsecMap8A['CX+(pb)'][idxA])*(xsecMap8A['BRZW'][idxA]+xsecMap8A['BRWh'][idxA])
   scaleA['JJLVJWPRIME13'][m] = (xsecMap13A['CX-(pb)'][idxA]+xsecMap13A['CX+(pb)'][idxA])*(xsecMap13A['BRZW'][idxA]+xsecMap13A['BRWh'][idxA])
