...
if [ $mass -gt 2000 ] #2100-4000
    then
    maxBoundary=100
    minBoundary=0.1
    echo "High mass $mass > 2000: boundary of combine is $minBoundary - $maxBoundary "
elif [ $mass -gt 1500 ] #1600-2000
    then
    maxBoundary=300
    minBoundary=0.03
    echo "High mass $mass 1600-2000: boundary of combine is $minBoundary - $maxBoundary "
elif [ $mass -gt 1100 ] #1200-1500
    then
    maxBoundary=100
    minBoundary=0.01
    ...
    echo "Low mass $mass 900 - 1100: boundary of combine is $minBoundary - $maxBoundary "
else #600-800
    maxBoundary=100
    minBoundary=0.01
    if [ $label == "lllv8" ]
    ...
    echo "Low mass $mass <900: boundary of combine is $minBoundary - $maxBoundary "
fi
