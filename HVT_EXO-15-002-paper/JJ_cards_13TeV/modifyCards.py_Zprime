...
for m in mass:
 ...
 card = "/CMS_jj_ZprimeWW_%s_13TeV_CMS_jj_VV.txt"%m
 ...
 for l in infile:
  ...
  if 'CMS_eff_vtag_tau21_sf_13TeV' in l:
   ...
   l = 'CMS_eff_vtag_tau21_sf_13TeV   lnN              %.3f/%.3f  %.3f/%.3f  -            %.3f/%.3f  %.3f/%.3f  -            %.3f/%.3f  %.3f/%.3f  -            %.3f/%.3f  %.3f/%.3f  -            %.3f/%.3f  %.3f/%.3f  -            %.3f/%.3f  %.3f/%.3f  -          '%(get_sys(m)[0],get_sys(m)[1],get_sys(m)[0],get_sys(m)[1],get_sys(m)[0],get_sys(m)[1],get_sys(m)[0],get_sys(m)[1],get_sys(m)[0],get_sys(m)[1],get_sys(m)[0],get_sys(m)[1],get_sys(m)[2],get_sys(m)[3],get_sys(m)[2],get_sys(m)[3],get_sys(m)[2],get_sys(m)[3],get_sys(m)[2],get_sys(m)[3],get_sys(m)[2],get_sys(m)[3],get_sys(m)[2],get_sys(m)[3])
   l+='\n'
   newline = 'CMS_eff_vtag_tau21_pt_13TeV   lnN              %.3f/%.3f  %.3f/%.3f  -            %.3f/%.3f  %.3f/%.3f  -            %.3f/%.3f  %.3f/%.3f  -            %.3f/%.3f  %.3f/%.3f  -            %.3f/%.3f  %.3f/%.3f  -            %.3f/%.3f  %.3f/%.3f  -          '%(get_sys_pt(m)[0],get_sys_pt(m)[1],get_sys_pt(m)[0],get_sys_pt(m)[1],get_sys_pt(m)[0],get_sys_pt(m)[1],get_sys_pt(m)[0],get_sys_pt(m)[1],get_sys_pt(m)[0],get_sys_pt(m)[1],get_sys_pt(m)[0],get_sys_pt(m)[1],get_sys_pt(m)[2],get_sys_pt(m)[3],get_sys_pt(m)[2],get_sys_pt(m)[3],get_sys_pt(m)[2],get_sys_pt(m)[3],get_sys_pt(m)[2],get_sys_pt(m)[3],get_sys_pt(m)[2],get_sys_pt(m)[3],get_sys_pt(m)[2],get_sys_pt(m)[3])
   #newline = newline.replace('0.794/1.176','%.3f/%.3f'%(get_sys_pt(m)[0],get_sys_pt(m)[1])).replace('1.121/0.885','%.3f/%.3f'%(get_sys_pt(m)[2],get_sys_pt(m)[3]))
   newline+='\n'
   l = l+newline
