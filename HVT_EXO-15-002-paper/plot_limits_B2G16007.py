...
def plot_Asympt_limits(label,mainLabel):
 ...
 names = {}
 names["JJLVJHVT13"]="lvJ + JJ channels"
 names["ALLHVT13"]="llJ, lvJ, vvJ, JJ (13 TeV)"
 names["jjwv13"]="JJ channel"
 names["lvjwv13"]="lvJ channel" 
 ...
 for m in mass:
  idx = int((m-800)/100)
  idxA = int((m-600)/50)
  scaleA['JJLVJHVT13'][m] = (xsecMap13A['CX-(pb)'][idxA]+xsecMap13A['CX+(pb)'][idxA])*(xsecMap13A['BRZW'][idxA]) + xsecMap13A['CX0(pb)'][idxA]*(xsecMap13A['BRWW'][idxA])
  ...
  if m >= 800:
   ...
   scaleB['JJLVJHVT13'][m] = (xsecMap13['CX-(pb)'][idx]+xsecMap13['CX+(pb)'][idx])*(xsecMap13['BRZW'][idx]) + xsecMap13['CX0(pb)'][idx]*(xsecMap13['BRWW'][idx])
   ...
   scale['JJLVJHVT13'][m] = (xsecMap13A['CX-(pb)'][idxA]+xsecMap13A['CX+(pb)'][idxA])*(xsecMap13A['BRZW'][idxA]) + xsecMap13A['CX0(pb)'][idxA]*(xsecMap13A['BRWW'][idxA])
 ...
 for m in mass:
  ...
  #print m,curAsymLimits[0]*scale[mainLabel][m]
  lastMass = m/1000.
  xbins.append( m/1000. );
 ...
 ytitle = "#sigma_{95%} #times BR_{V' #rightarrow WV} (pb)"
 ...
 #theoleg = "#sigma_{TH} #times BR_{V' #rightarrow WV} , HVT_{B}"
...
def compare_Asympt_limits(labels,unblind,bands):
 ...
 lcol["lvjwv13"] = col.GetColor(palette[11])
 ...
 mcol["lvjwv13"] = col.GetColor(palette[11])
...
if __name__ == '__main__':
 ...
 # 13 TeV LVJ+JJ only
 scenarios["JJLVJHVT13TeV"]=["JJLVJHVT13","lvjwv13","jjwv13"]
