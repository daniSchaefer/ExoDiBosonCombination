...
def fill_histos_for_contour(mass,limit,max_width):
  ...
  for e in range(t13.GetEntries()):
   t13.GetEntry(e)
   br = brvv8[0]+brvh8[0]+brvv13[0]+brvh13[0] 
   if br < limit:
...
obs_lim = {'1500': 0.0524,'2000': 0.0338,'3000': 0.0145} #8+13 TeV WV+VH combo
max_width = 0.06
models = ['B']
...
linestyle = {'1000':1,'1500':8,'2000':1,'3000':7}
lim_text_pos = {'1000':[0.5138191,0.4825175,0.5942211,0.5629371],'1500':[0.4468391,0.485119,0.5948276,0.5550595],
                '2000':[0.6206897,0.2752976,0.6925287,0.3452381],'3000':[0.6609195,0.7276786,0.7284483,0.797619]}
...
g_models = []
mcols = {'B':kMagenta,'A1':210,'A2':kBlue,'A3':kOrange,'A4':kAzure+8,'A5':kRed}
for m in models:
