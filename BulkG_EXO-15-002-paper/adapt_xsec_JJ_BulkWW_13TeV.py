...
for mass in masses:
 ...
 try:
   fWW=open("JJ_cards_13TeV/CMS_jj_BulkWW_"+str(mass)+"_13TeV_CMS_jj_VV.txt").readlines()
 except:
   print "could not open"
   continue
 outfile="JJ_cards_13TeV/CMS_jj_BulkWWfix_"+str(mass)+"_13TeV_CMS_jj_VV.txt"
 print outfile
 f=open(outfile,"w")
 ...
 for l in range(len(fWW)):
  ...
  if "rate" in fWW[l]:
   ...
   for s in range(len(fWWsplit)):
    ...
    if signal:
     #print (numberWW*100/2564.649)*100
