...
def plot_Asympt_limits(label,mainLabel):
 ...
 names = {}
 names["ALL13"]="lvJ + JJ channels"
 names["ALLWW13"]="lvJ + JJ channels"
 names["ALLZZ13"]="JJ channel" 
 names["ALL8"]="lvJ, llJ, JJ (8 TeV)"
 names["xww"]="lvqq (8 TeV)"
 names['xzz']="llqq (8 TeV)"
 names["xjj8"]="qqqq (8 TeV)"
 names["xjj13"]="JJ channel"
 names["xjj13zz"]="JJ channel"
 names["xjj13ww"]="JJ channel"
 names["xww13"]="lvJ channel"
 ...
 for m in mass:
  ...
  scale['xjj13ww'][m] = theMap13['WW'][idx]
  scale['xjj13zz'][m] = theMap13['ZZ'][idx]
 ...
 if mainLabel == "xjj13ww": ytitle = "#sigma_{95%} #times BR_{G_{bulk} #rightarrow WW} (pb)"
 if mainLabel == "xjj13zz": ytitle = "#sigma_{95%} #times BR_{G_{bulk} #rightarrow ZZ} (pb)"
 ...
 if mainLabel == "xjj13ww": theoleg = "#sigma_{TH} #times BR_{G_{bulk} #rightarrow WW} , #tilde{k}=0.5"
 if mainLabel == "xjj13zz": theoleg = "#sigma_{TH} #times BR_{G_{bulk} #rightarrow ZZ} , #tilde{k}=0.5"
...
if __name__ == '__main__':
 ...
 # 13 TeV BulkG
 scenarios["ALLWW13TeV"]=["xjj13ww","xww13"]

 # 13 TeV BulkG
 scenarios["ALLZZ13TeV"]=["xjj13zz"]
