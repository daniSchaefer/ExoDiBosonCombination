...
for mass in masses:
 ...
 outfile="JJ_cards_13TeV/CMS_jj_Wprimefix_WZ_"+str(mass)+"_13TeV_CMS_jj_VV.txt"
 print outfile
 f=open(outfile,"w")
  ...
  if "rate" in fWZ[l]:
   ...
   for s in range(len(fWZsplit)):
    ...
    if signal:
     ...
     #print  numberWZ*100*0.6760*0.6991*0.6760*0.6991/2564.649
     #print numberWZ*100*0.6760*0.6991*0.6760*0.6991*100/2564.649
