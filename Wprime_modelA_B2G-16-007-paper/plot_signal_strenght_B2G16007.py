...
def plot_Asympt_limits(label):
 ...
 if label.find("13") != -1 and label.find("8") == -1:
  if label.find("JJLVJ") != -1: lumi13 = "2.3-2.7"
...
def compare_Asympt_limits(labels,unblind,bands):
 ...
 legs3["ALLWPRIME138"]=[0.15,0.60,0.41,0.89]
    
 ymin = {}
 ymax = {}  
 ymin["ALLHVWPRIME138"] = 0.05
 ymax["ALLHVWPRIME138"] = 350
 ymin["ALLWVWPRIME138"] = 0.03
 ymax["ALLWVWPRIME138"] = 100
 ymin["ALLWPRIME138"] = 0.02
 ymax["ALLWPRIME138"] = 300
 ...
 leg = ROOT.TLegend(0.45,0.17,0.89,0.35)
