...
//=========  (Fri Oct 21 12:51:38 2016) by ROOT version5.34/18
   ...
   Graph_Expected1->SetMaximum(0.3474445);
   ...
   Graph_Observed2->SetMinimum(0.003488967);
   Graph_Observed2->SetMaximum(0.5496123);
