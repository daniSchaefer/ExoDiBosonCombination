...
//=========  (Fri Oct 21 12:51:30 2016) by ROOT version5.34/18
   ...
   Graph_Expected1->SetMinimum(3.186236e-09);
   Graph_Expected1->SetMaximum(0.4767207);
   ...
   Graph_Observed2->SetMinimum(0.07323128);
   Graph_Observed2->SetMaximum(0.5387972);
