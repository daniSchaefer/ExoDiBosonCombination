...
//=========  (Fri Oct 21 12:51:26 2016) by ROOT version5.34/18
   ...
   Graph_Expected1->SetMinimum(2.948794e-08);
   Graph_Expected1->SetMaximum(0.4889433);
   ...
   Graph_Observed2->SetMinimum(0.01357582);
   Graph_Observed2->SetMaximum(0.5484916);
