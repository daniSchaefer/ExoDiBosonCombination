...
//=========  (Fri Oct 21 12:51:14 2016) by ROOT version5.34/18
   ...
   Graph_Expected1->SetMinimum(6.567282e-11);
   ...
   Graph_Observed2->SetMinimum(0.002875724);
   Graph_Observed2->SetMaximum(0.5496805);
