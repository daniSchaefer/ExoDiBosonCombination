...
//=========  (Fri Oct 21 12:51:34 2016) by ROOT version5.34/18
   ...
   Graph_Expected1->SetMaximum(0.518179);
   ...
   Graph_Observed2->SetMinimum(0.01128447);
   Graph_Observed2->SetMaximum(0.5487462);
