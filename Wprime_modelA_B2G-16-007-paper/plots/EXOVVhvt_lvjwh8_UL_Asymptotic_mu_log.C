...
//=========  (Fri Oct 21 12:52:39 2016) by ROOT version5.34/18
   ...
   grae->SetPoint(35,0.8,0.7159392);
   grae->SetPointError(35,0,0,0,0);
   
   TH1F *Graph_Limit95CLs17 = new TH1F("Graph_Limit95CLs17","Graph",100,0.63,2.67);
   Graph_Limit95CLs17->SetMinimum(0.1483927);
   Graph_Limit95CLs17->SetMaximum(104.2067);
   ...
   grae->SetPointError(34,0,0,0,0);
   grae->SetPoint(35,0.8,0.4933653);
   grae->SetPointError(35,0,0,0,0);
   
   TH1F *Graph_Limit68CLs18 = new TH1F("Graph_Limit68CLs18","Graph",100,0.63,2.67);
   Graph_Limit68CLs18->SetMinimum(0.2038922);
   Graph_Limit68CLs18->SetMaximum(65.31892);
   ...
   Graph_LimitExpectedCLs19->SetMinimum(0.2979492);
   Graph_LimitExpectedCLs19->SetMaximum(34.34189);
   ...
   Graph_LimitObservedCLs20->SetMinimum(0.2403994);
   Graph_LimitObservedCLs20->SetMaximum(27.68551);
