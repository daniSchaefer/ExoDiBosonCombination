...
//=========  (Fri Oct 21 12:51:10 2016) by ROOT version5.34/18
   ...
   Graph_Expected1->SetMinimum(1.221444e-09);
   ...
   Graph_Observed2->SetMinimum(0.004284324);
   Graph_Observed2->SetMaximum(0.549524);
