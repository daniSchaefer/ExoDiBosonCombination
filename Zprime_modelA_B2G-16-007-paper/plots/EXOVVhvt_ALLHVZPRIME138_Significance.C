...
//=========  (Fri Oct 21 13:01:18 2016) by ROOT version5.34/18
   ...
   Graph_Expected1->SetMinimum(5.575971e-08);
   Graph_Expected1->SetMaximum(0.2985139);
   ...
   Graph_Observed2->SetMinimum(0.0322425);
   Graph_Observed2->SetMaximum(0.5425234);
