...
//=========  (Fri Oct 21 13:01:26 2016) by ROOT version5.34/18
   ...
   Graph_Expected1->SetMinimum(1.344787e-14);
   Graph_Expected1->SetMaximum(0.4184976);
   ...
   Graph_Observed2->SetMinimum(0.02296872);
   Graph_Observed2->SetMaximum(0.5474479);
