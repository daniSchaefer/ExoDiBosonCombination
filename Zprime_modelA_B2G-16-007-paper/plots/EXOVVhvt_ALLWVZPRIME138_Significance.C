...
//=========  (Fri Oct 21 13:01:11 2016) by ROOT version5.34/18
   ...
   Graph_Expected1->SetMinimum(2.211994e-10);
   ...
   Graph_Observed2->SetMinimum(0.01351571);
   Graph_Observed2->SetMaximum(0.5484983);
