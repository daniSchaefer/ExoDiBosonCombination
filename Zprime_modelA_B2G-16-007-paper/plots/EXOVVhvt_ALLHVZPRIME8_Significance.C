...
//=========  (Fri Oct 21 13:01:15 2016) by ROOT version5.34/18
   ...
   Graph_Expected1->SetMinimum(0.01437312);
   Graph_Expected1->SetMaximum(0.5292383);
   ...
   Graph_Observed2->SetMinimum(0.03687623);
   Graph_Observed2->SetMaximum(0.5421022);
