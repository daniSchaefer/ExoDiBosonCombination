...
//=========  (Fri Oct 21 13:01:03 2016) by ROOT version5.34/18
   ...
   Graph_Expected1->SetMinimum(2.083761e-10);
   ...
   Graph_Observed2->SetMinimum(0.02375796);
   Graph_Observed2->SetMaximum(0.5473602);
