...
//=========  (Fri Oct 21 13:01:07 2016) by ROOT version5.34/18
   ...
   Graph_Expected1->SetMinimum(1.319848e-08);
   ...
   Graph_Observed2->SetMinimum(0.011337);
   Graph_Observed2->SetMaximum(0.5444239);
