...
//=========  (Fri Oct 21 13:01:22 2016) by ROOT version5.34/18
   ...
   Graph_Expected1->SetMinimum(8.42068e-09);
   Graph_Expected1->SetMaximum(0.5346955);
   ...
   Graph_Observed2->SetMinimum(0.003744068);
   Graph_Observed2->SetMaximum(0.5451142);
