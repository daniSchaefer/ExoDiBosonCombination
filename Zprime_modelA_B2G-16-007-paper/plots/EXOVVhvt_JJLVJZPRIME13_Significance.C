...
//=========  (Fri Oct 21 13:01:00 2016) by ROOT version5.34/18
   ...
   Graph_Expected1->SetMaximum(0.4184975);
   ...
   Graph_Observed2->SetMinimum(0.013659);
   Graph_Observed2->SetMaximum(0.5484823);
