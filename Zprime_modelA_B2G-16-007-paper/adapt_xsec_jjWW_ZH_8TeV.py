  ...
  if "rate" in fWW[l]:
   ...
   for s in range(len(fWWsplit)):
    ...
    if signal:
     ...
     #print eff,HVTWW[mass]*0.6991/0.6760+HVTZH[mass],HVTWW[mass]+0.14*0.577*HVTZH[mass]/0.9/0.6760
     numberWW=numberWW*100.*HVTWW[mass]*0.6760/0.6991+eff*0.14*0.577*19700.*HVTZH[mass]/0.9/0.6760
