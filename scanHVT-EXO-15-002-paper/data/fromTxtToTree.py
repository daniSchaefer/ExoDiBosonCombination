...
outfile = TFile.Open('scanHVT-M3500.root','RECREATE')
outtree = TTree("hvtM3500","hvtM3500")
...
infile13 = open('scanHVT-M3500.txt','r')
lines = infile13.readlines()

#infile8 = open('data/scanHVT-M3500_8TeV.txt','r')
infile13 = open('scanHVT-M3500.txt','r')    
nlines = -1
