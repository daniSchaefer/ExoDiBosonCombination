...
for m in mass:
 ...
 for l in infile:
  ...
  if 'CMS_eff_vtag_tau21_sf_13TeV' in l:
   ...
   newline = 'CMS_eff_vtag_tau21_pt_13TeV   lnN              1.121/0.885  1.121/0.885  1.121/0.885  -            1.121/0.885  1.121/0.885  1.121/0.885  -            1.121/0.885  1.121/0.885  1.121/0.885  -            0.794/1.176  0.794/1.176  0.794/1.176  -            0.794/1.176  0.794/1.176  0.794/1.176  -            0.794/1.176  0.794/1.176  0.794/1.176  -          ' 
   newline = newline.replace('1.121/0.885','%.3f/%.3f'%(get_sys_pt(m)[0],get_sys_pt(m)[1])).replace('0.794/1.176','%.3f/%.3f'%(get_sys_pt(m)[2],get_sys_pt(m)[3]))
   newline+='\n'
   l = l+newline
