...
for mass in masses:
 ...
 HVTWH[mass]=(xsecMap['CX-(pb)'][m]+xsecMap['CX+(pb)'][m])*xsecMap['BRWh'][m]
 ...
 for l in range(len(fWW)):
  ...
  if "rate" in fWW[l]:
   ...
   for s in range(len(fWWsplit)):
    ...
    if signal:
     #print tot/(HVTWZ[mass]+HVTWW[mass]*0.6760/0.6991+0.14*0.577*HVTZH[mass]/0.9/0.6760+0.14*0.577*HVTWH[mass]/0.9/0.6991)
     effWZ = numberWW*100./19700.
     numberWW=numberWW*100.*HVTWZ[mass]+numberWW*100.*HVTWW[mass]*0.6760/0.6991+effWZ*0.14*0.577*19700.*HVTZH[mass]/0.9/0.6760+effWZ*0.14*0.577*19700.*HVTWH[mass]/0.9/0.6991
