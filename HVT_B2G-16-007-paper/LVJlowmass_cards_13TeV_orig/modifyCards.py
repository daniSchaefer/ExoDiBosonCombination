...
mass =[600,700,750,800]

indir = 'LVJlowmass_cards_13TeV/'
outdir = 'LVJlowmass_cards_13TeV/'
  
for m in mass:

 card = "/wwlvj_Vprime%s_em_HP_unbin.txt"%m
 ...
 for l in infile:
  ...
  if 'CMS_eff_vtag_tau21_sf_13TeV' in l:
   ...
   newline = 'CMS_eff_vtag_tau21_pt_13TeV   lnN               1.056/0.944          1.056/0.944    -		   -		  1.056/0.944	 -		  1.056/0.944	      1.056/0.944    -  	    -		   1.056/0.944    -   ' 

   newline = newline.replace('1.056/0.944','%.3f'%(1+syst))
   newline+='\n'
   l = l+newline
