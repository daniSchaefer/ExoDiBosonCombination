...
def plot_Asympt_limits(label,mainLabel):
 ...
 for m in mass:
  ...
  scaleA['ALLWVHVT8'][m] = (xsecMap8A['CX-(pb)'][idxA]+xsecMap8A['CX+(pb)'][idxA])*(xsecMap8A['BRZW'][idxA]+xsecMap8A['BRWh'][idxA]) + xsecMap8A['CX0(pb)'][idxA]*(xsecMap8A['BRWW'][idxA]+xsecMap8A['BRhZ'][idxA])
  scaleA['ALLHVHVT8'][m] = (xsecMap8A['CX-(pb)'][idxA]+xsecMap8A['CX+(pb)'][idxA])*(xsecMap8A['BRZW'][idxA]+xsecMap8A['BRWh'][idxA]) + xsecMap8A['CX0(pb)'][idxA]*(xsecMap8A['BRWW'][idxA]+xsecMap8A['BRhZ'][idxA])
  scaleA['ALLHVT8'][m]   = (xsecMap8A['CX-(pb)'][idxA]+xsecMap8A['CX+(pb)'][idxA])*(xsecMap8A['BRZW'][idxA]+xsecMap8A['BRWh'][idxA]) + xsecMap8A['CX0(pb)'][idxA]*(xsecMap8A['BRWW'][idxA]+xsecMap8A['BRhZ'][idxA])
  scaleA['JJLVJHVT13'][m]= (xsecMap13A['CX-(pb)'][idxA]+xsecMap13A['CX+(pb)'][idxA])*(xsecMap13A['BRZW'][idxA]+xsecMap13A['BRWh'][idxA]) + xsecMap13A['CX0(pb)'][idxA]*(xsecMap13A['BRWW'][idxA]+xsecMap13A['BRhZ'][idxA])
  scaleA['ALLHVT13'][m] =  (xsecMap13A['CX-(pb)'][idxA]+xsecMap13A['CX+(pb)'][idxA])*(xsecMap13A['BRZW'][idxA]+xsecMap13A['BRWh'][idxA]) + xsecMap13A['CX0(pb)'][idxA]*(xsecMap13A['BRWW'][idxA]+xsecMap13A['BRhZ'][idxA])
  ...
  if m >= 800:
   ...
   scaleB['ALLWVHVT8'][m] = 1
   scaleB['ALLHVHVT8'][m] = 1
   scaleB['ALLHVT8'][m] = 1
   scaleB['JJLVJHVT13'][m] = (xsecMap13['CX-(pb)'][idx]+xsecMap13['CX+(pb)'][idx])*(xsecMap13['BRZW'][idx]+xsecMap13['BRWh'][idx]) + xsecMap13['CX0(pb)'][idx]*(xsecMap13['BRWW'][idx]+xsecMap13['BRhZ'][idx])
   scaleB['ALLHVT13'][m] = (xsecMap13['CX-(pb)'][idx]+xsecMap13['CX+(pb)'][idx])*(xsecMap13['BRZW'][idx]+xsecMap13['BRWh'][idx]) + xsecMap13['CX0(pb)'][idx]*(xsecMap13['BRWW'][idx]+xsecMap13['BRhZ'][idx])
   if m <= 3000:
    ...
    scaleB['ALLWVHVT8'][m] = (xsecMap8['CX-(pb)'][idx2]+xsecMap8['CX+(pb)'][idx2])*(xsecMap8['BRZW'][idx2]+xsecMap8['BRWh'][idx2]) + xsecMap8['CX0(pb)'][idx2]*(xsecMap8['BRWW'][idx2]+xsecMap8['BRhZ'][idx2])
    scaleB['ALLHVHVT8'][m] = (xsecMap8['CX-(pb)'][idx2]+xsecMap8['CX+(pb)'][idx2])*(xsecMap8['BRZW'][idx2]+xsecMap8['BRWh'][idx2]) + xsecMap8['CX0(pb)'][idx2]*(xsecMap8['BRWW'][idx2]+xsecMap8['BRhZ'][idx2])
    scaleB['ALLHVT8'][m] =   (xsecMap8['CX-(pb)'][idx2]+xsecMap8['CX+(pb)'][idx2])*(xsecMap8['BRZW'][idx2]+xsecMap8['BRWh'][idx2]) + xsecMap8['CX0(pb)'][idx2]*(xsecMap8['BRWW'][idx2]+xsecMap8['BRhZ'][idx2])
  else:
   scale['ALLWVHVT8'][m]  = (xsecMap8A['CX-(pb)'][idxA]+xsecMap8A['CX+(pb)'][idxA])*(xsecMap8A['BRZW'][idxA]+xsecMap8A['BRWh'][idxA]) + xsecMap8A['CX0(pb)'][idxA]*(xsecMap8A['BRWW'][idxA]+xsecMap8A['BRhZ'][idxA])
   scale['ALLHVHVT8'][m]  = (xsecMap8A['CX-(pb)'][idxA]+xsecMap8A['CX+(pb)'][idxA])*(xsecMap8A['BRZW'][idxA]+xsecMap8A['BRWh'][idxA]) + xsecMap8A['CX0(pb)'][idxA]*(xsecMap8A['BRWW'][idxA]+xsecMap8A['BRhZ'][idxA])
   scale['ALLHVT8'][m]    = (xsecMap8A['CX-(pb)'][idxA]+xsecMap8A['CX+(pb)'][idxA])*(xsecMap8A['BRZW'][idxA]+xsecMap8A['BRWh'][idxA]) + xsecMap8A['CX0(pb)'][idxA]*(xsecMap8A['BRWW'][idxA]+xsecMap8A['BRhZ'][idxA])
   scale['JJLVJHVT13'][m] = (xsecMap13A['CX-(pb)'][idxA]+xsecMap13A['CX+(pb)'][idxA])*(xsecMap13A['BRZW'][idxA]+xsecMap13A['BRWh'][idxA]) + xsecMap13A['CX0(pb)'][idxA]*(xsecMap13A['BRWW'][idxA]+xsecMap13A['BRhZ'][idxA])
   scale['ALLHVT13'][m]   = (xsecMap13A['CX-(pb)'][idxA]+xsecMap13A['CX+(pb)'][idxA])*(xsecMap13A['BRZW'][idxA]+xsecMap13A['BRWh'][idxA]) + xsecMap13A['CX0(pb)'][idxA]*(xsecMap13A['BRWW'][idxA]+xsecMap13A['BRhZ'][idxA])
...
def compare_Asympt_limits(labels,unblind,bands):
 ...
 while i < 3.:
  i+=0.01 
  if not unblind or (unblind and bands): y = graphobs[1].Eval(i)
  else: y = graphexp[1].Eval(i) 
