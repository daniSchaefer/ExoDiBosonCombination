...
//=========  (Fri Oct 21 12:58:46 2016) by ROOT version5.34/18
   ...
   TH1F *Graph_Expected1 = new TH1F("Graph_Expected1","Graph",100,0.58,3.22);
   Graph_Expected1->SetMinimum(3.8884e-08);
   Graph_Expected1->SetMaximum(0.2324911);
   ...
   TH1F *Graph_Observed2 = new TH1F("Graph_Observed2","Graph",100,0.58,3.22);
   Graph_Observed2->SetMinimum(0.03223885);
   Graph_Observed2->SetMaximum(0.5425237);
