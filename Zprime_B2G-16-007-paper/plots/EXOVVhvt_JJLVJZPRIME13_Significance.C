...
//=========  (Fri Oct 21 12:58:28 2016) by ROOT version5.34/18
   ...
   Graph_Expected1->SetMinimum(1.220417e-07);
   ...
   Graph_Observed2->SetMinimum(0.01362605);
   Graph_Observed2->SetMaximum(0.548486);
