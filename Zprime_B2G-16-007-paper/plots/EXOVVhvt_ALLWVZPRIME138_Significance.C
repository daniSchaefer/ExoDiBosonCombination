...
//=========  (Fri Oct 21 12:58:39 2016) by ROOT version5.34/18
   ...
   Graph_Expected1->SetMinimum(1.551795e-08);
   ...
   Graph_Observed2->SetMinimum(0.01347735);
   Graph_Observed2->SetMaximum(0.5485025);
