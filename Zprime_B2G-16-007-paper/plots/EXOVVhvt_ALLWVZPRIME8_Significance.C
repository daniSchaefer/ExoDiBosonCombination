...
//=========  (Fri Oct 21 12:58:35 2016) by ROOT version5.34/18
   ...
   Graph_Expected1->SetMinimum(6.709191e-05);
   Graph_Expected1->SetMaximum(0.5271606);
   ...
   Graph_Observed2->SetMinimum(0.01089068);
   Graph_Observed2->SetMaximum(0.5444645);
