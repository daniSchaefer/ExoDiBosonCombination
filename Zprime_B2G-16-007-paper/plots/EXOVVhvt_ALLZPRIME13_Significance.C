...
//=========  (Fri Oct 21 12:58:31 2016) by ROOT version5.34/18
   ...
   Graph_Expected1->SetMinimum(2.35586e-09);
   ...
   Graph_Observed2->SetMinimum(0.02389138);
   Graph_Observed2->SetMaximum(0.5473454);
