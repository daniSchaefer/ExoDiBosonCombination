...
def plot_Asympt_limits(label,mainLabel):
 ...
 scale['ALLZPRIME8'] = {}
 scaleA = {}
 scaleA['JJLVJZPRIME13'] = {}
 scaleA['ALLZPRIME13'] = {}
 scaleA['ALLWVZPRIME8'] = {}
 scaleA['ALLHVZPRIME8'] = {}
 scaleA['ALLZPRIME8'] = {}
 scaleB = {}
 scaleB['JJLVJZPRIME13'] = {}
 scaleB['ALLZPRIME13'] = {}
 scaleB['ALLWVZPRIME8'] = {}
 scaleB['ALLHVZPRIME8'] = {}
 scaleB['ALLZPRIME8'] = {} 
 ...
 for m in mass:
  ...
  scaleA['ALLWVZPRIME8'][m] = xsecMap8A['CX0(pb)'][idxA]*(xsecMap8A['BRWW'][idxA]+xsecMap8A['BRhZ'][idxA])
  scaleA['ALLHVZPRIME8'][m] = xsecMap8A['CX0(pb)'][idxA]*(xsecMap8A['BRWW'][idxA]+xsecMap8A['BRhZ'][idxA])
  scaleA['ALLZPRIME8'][m] = xsecMap8A['CX0(pb)'][idxA]*(xsecMap8A['BRWW'][idxA]+xsecMap8A['BRhZ'][idxA])
  scaleA['JJLVJZPRIME13'][m] = xsecMap13A['CX0(pb)'][idxA]*(xsecMap13A['BRWW'][idxA]+xsecMap13A['BRhZ'][idxA])
  scaleA['ALLZPRIME13'][m] = xsecMap13A['CX0(pb)'][idxA]*(xsecMap13A['BRWW'][idxA]+xsecMap13A['BRhZ'][idxA])  
  ...
  if m>=800:
   ...
   scaleB['ALLWVZPRIME8'][m] = 1
   scaleB['ALLHVZPRIME8'][m] = 1
   scaleB['ALLZPRIME8'][m] = 1
   scaleB['JJLVJZPRIME13'][m] = xsecMap13['CX0(pb)'][idx]*(xsecMap13['BRWW'][idx]+xsecMap13['BRhZ'][idx])
   scaleB['ALLZPRIME13'][m] = xsecMap13['CX0(pb)'][idx]*(xsecMap13['BRWW'][idx]+xsecMap13['BRhZ'][idx])
   if m<= 3000:
    ...
    scaleB['ALLWVZPRIME8'][m] = xsecMap8['CX0(pb)'][idx2]*(xsecMap8['BRWW'][idx2]+xsecMap8['BRhZ'][idx2])
    scaleB['ALLHVZPRIME8'][m] = xsecMap8['CX0(pb)'][idx2]*(xsecMap8['BRWW'][idx2]+xsecMap8['BRhZ'][idx2])
    scaleB['ALLZPRIME8'][m] = xsecMap8['CX0(pb)'][idx2]*(xsecMap8['BRWW'][idx2]+xsecMap8['BRhZ'][idx2])
  else: 
   scale['ALLWVZPRIME8'][m] = xsecMap8A['CX0(pb)'][idxA]*(xsecMap8A['BRWW'][idxA]+xsecMap8A['BRhZ'][idxA])
   scale['ALLHVZPRIME8'][m] = xsecMap8A['CX0(pb)'][idxA]*(xsecMap8A['BRWW'][idxA]+xsecMap8A['BRhZ'][idxA])
   scale['ALLZPRIME8'][m] = xsecMap8A['CX0(pb)'][idxA]*(xsecMap8A['BRWW'][idxA]+xsecMap8A['BRhZ'][idxA])
   scale['JJLVJZPRIME13'][m] = xsecMap13A['CX0(pb)'][idxA]*(xsecMap13A['BRWW'][idxA]+xsecMap13A['BRhZ'][idxA])
   scale['ALLZPRIME13'][m] = xsecMap13A['CX0(pb)'][idxA]*(xsecMap13A['BRWW'][idxA]+xsecMap13A['BRhZ'][idxA])  
