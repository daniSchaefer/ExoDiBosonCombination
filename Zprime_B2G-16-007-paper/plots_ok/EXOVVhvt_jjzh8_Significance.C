...
//=========  (Fri Oct 14 00:24:02 2016) by ROOT version5.34/18
   ...
   c_Significance->Range(0.44125,-5.888889,2.81625,1.518519);
   ...
   TH1F *Graph_Expected9 = new TH1F("Graph_Expected9","Graph",100,0.84,2.76);
   Graph_Expected9->SetMinimum(0.1368052);
   Graph_Expected9->SetMaximum(0.5060403);
   ...
   TH1F *Graph_Observed10 = new TH1F("Graph_Observed10","Graph",100,0.84,2.76);
   Graph_Observed10->SetMinimum(0.008676962);
   Graph_Observed10->SetMaximum(0.5446657);
