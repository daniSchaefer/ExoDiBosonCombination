...
//=========  (Fri Oct 14 00:23:49 2016) by ROOT version5.34/18
   ...
   TH1F *Graph_Expected1 = new TH1F("Graph_Expected1","Graph",100,0.62,2.78);
   Graph_Expected1->SetMinimum(0.007700481);
   Graph_Expected1->SetMaximum(0.5219391);
   ...
   Graph_Observed2->SetMinimum(0.0369186);
   Graph_Observed2->SetMaximum(0.5420983);
