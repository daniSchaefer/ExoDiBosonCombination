...
//=========  (Fri Oct 14 10:16:20 2016) by ROOT version5.34/18
   ...
   grae->SetPoint(38,0.7,7.764767);
   grae->SetPointError(38,0,0,0,0);
   grae->SetPoint(39,0.6,21.41855);
   ...
   Graph_Limit95CLs9->SetMaximum(23.55515);
   ...
   Graph_LimitExpectedCLs11->SetMaximum(11.73395);
   ...
   Graph_LimitObservedCLs12->SetMaximum(16.49642);
