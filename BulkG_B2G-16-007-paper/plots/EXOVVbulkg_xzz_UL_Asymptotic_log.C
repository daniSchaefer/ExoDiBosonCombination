...
//=========  (Fri Oct 21 13:12:16 2016) by ROOT version5.34/18
   ...
   grae->SetPoint(0,0.6,0.9278893);
   grae->SetPointError(0,0,0,0,0);
   grae->SetPoint(1,0.7,1.673913);
   grae->SetPointError(1,0,0,0,0);
   grae->SetPoint(2,0.8,2.949572);
   grae->SetPointError(2,0,0,0,0);
   grae->SetPoint(3,0.9,5.091);
   grae->SetPointError(3,0,0,0,0);
   grae->SetPoint(4,1,7.955074);
   grae->SetPointError(4,0,0,0,0);
   grae->SetPoint(5,1.1,12.93125);
   grae->SetPointError(5,0,0,0,0);
   grae->SetPoint(6,1.2,20.79391);
   grae->SetPointError(6,0,0,0,0);
   grae->SetPoint(7,1.3,31.28662);
   grae->SetPointError(7,0,0,0,0);
   grae->SetPoint(8,1.4,44.50912);
   grae->SetPointError(8,0,0,0,0);
   grae->SetPoint(9,1.5,73.17657);
   grae->SetPointError(9,0,0,0,0);
   grae->SetPoint(10,1.6,102.8114);
   grae->SetPointError(10,0,0,0,0);
   grae->SetPoint(11,1.7,153.0922);
   grae->SetPointError(11,0,0,0,0);
   grae->SetPoint(12,1.8,219.7174);
   grae->SetPointError(12,0,0,0,0);
   grae->SetPoint(13,1.9,338.8115);
   grae->SetPointError(13,0,0,0,0);
   grae->SetPoint(14,2,489.6927);
   grae->SetPointError(14,0,0,0,0);
   grae->SetPoint(15,2.1,721.7789);
   grae->SetPointError(15,0,0,0,0);
   grae->SetPoint(16,2.2,1041.813);
   grae->SetPointError(16,0,0,0,0);
   grae->SetPoint(17,2.3,1602.081);
   grae->SetPointError(17,0,0,0,0);
   grae->SetPoint(18,2.4,2241.562);
   grae->SetPointError(18,0,0,0,0);
   grae->SetPoint(19,2.5,3220.367);
   grae->SetPointError(19,0,0,0,0);
   grae->SetPoint(20,2.5,31749.83);
   grae->SetPointError(20,0,0,0,0);
   grae->SetPoint(21,2.4,21223.81);
   grae->SetPointError(21,0,0,0,0);
   grae->SetPoint(22,2.3,14548.06);
   grae->SetPointError(22,0,0,0,0);
   grae->SetPoint(23,2.2,9062.918);
   grae->SetPointError(23,0,0,0,0);
   grae->SetPoint(24,2.1,6041.449);
   grae->SetPointError(24,0,0,0,0);
   grae->SetPoint(25,2,3908.531);
   grae->SetPointError(25,0,0,0,0);
   grae->SetPoint(26,1.9,2636.156);
   grae->SetPointError(26,0,0,0,0);
   grae->SetPoint(27,1.8,1655.456);
   grae->SetPointError(27,0,0,0,0);
   grae->SetPoint(28,1.7,1125.997);
   grae->SetPointError(28,0,0,0,0);
   grae->SetPoint(29,1.6,735.2122);
   grae->SetPointError(29,0,0,0,0);
   grae->SetPoint(30,1.5,499.65);
   grae->SetPointError(30,0,0,0,0);
   grae->SetPoint(31,1.4,284.9588);
   grae->SetPointError(31,0,0,0,0);
   grae->SetPoint(32,1.3,185.8295);
   grae->SetPointError(32,0,0,0,0);
   grae->SetPoint(33,1.2,117.0693);
   grae->SetPointError(33,0,0,0,0);
   grae->SetPoint(34,1.1,68.2959);
   grae->SetPointError(34,0,0,0,0);
   grae->SetPoint(35,1,39.34651);
   grae->SetPointError(35,0,0,0,0);
   grae->SetPoint(36,0.9,23.72928);
   grae->SetPointError(36,0,0,0,0);
   grae->SetPoint(37,0.8,12.81815);
   grae->SetPointError(37,0,0,0,0);
   grae->SetPoint(38,0.7,6.836943);
   grae->SetPointError(38,0,0,0,0);
   grae->SetPoint(39,0.6,3.462662);
   grae->SetPointError(39,0,0,0,0);
   
   TH1F *Graph_Limit95CLs5 = new TH1F("Graph_Limit95CLs5","Graph",100,0.41,2.69);
   Graph_Limit95CLs5->SetMinimum(0.8351004);
   Graph_Limit95CLs5->SetMaximum(34924.72);
   ...
   grae->SetLineWidth(3);
   grae->SetMarkerStyle(20);
   grae->SetPoint(0,0.6,1.213933);
   grae->SetPointError(0,0,0,0,0);
   grae->SetPoint(1,0.7,2.240959);
   grae->SetPointError(1,0,0,0,0);
   grae->SetPoint(2,0.8,4.002202);
   grae->SetPointError(2,0,0,0,0);
   grae->SetPoint(3,0.9,6.984325);
   grae->SetPointError(3,0,0,0,0);
   grae->SetPoint(4,1,11.00749);
   grae->SetPointError(4,0,0,0,0);
   grae->SetPoint(5,1.1,18.01973);
   grae->SetPointError(5,0,0,0,0);
   grae->SetPoint(6,1.2,29.37065);
   grae->SetPointError(6,0,0,0,0);
   grae->SetPoint(7,1.3,44.311);
   grae->SetPointError(7,0,0,0,0);
   grae->SetPoint(8,1.4,63.93668);
   grae->SetPointError(8,0,0,0,0);
   grae->SetPoint(9,1.5,105.9221);
   grae->SetPointError(9,0,0,0,0);
   grae->SetPoint(10,1.6,150.3103);
   grae->SetPointError(10,0,0,0,0);
   grae->SetPoint(11,1.7,225.6052);
   grae->SetPointError(11,0,0,0,0);
   grae->SetPoint(12,1.8,328.0846);
   grae->SetPointError(12,0,0,0,0);
   grae->SetPoint(13,1.9,510.8808);
   grae->SetPointError(13,0,0,0,0);
   grae->SetPoint(14,2,748.8633);
   grae->SetPointError(14,0,0,0,0);
   grae->SetPoint(15,2.1,1123.744);
   grae->SetPointError(15,0,0,0,0);
   grae->SetPoint(16,2.2,1642.481);
   grae->SetPointError(16,0,0,0,0);
   grae->SetPoint(17,2.3,2575.495);
   grae->SetPointError(17,0,0,0,0);
   grae->SetPoint(18,2.4,3662.933);
   grae->SetPointError(18,0,0,0,0);
   grae->SetPoint(19,2.5,5343.917);
   grae->SetPointError(19,0,0,0,0);
   grae->SetPoint(20,2.5,21067.89);
   grae->SetPointError(20,0,0,0,0);
   grae->SetPoint(21,2.4,14083.25);
   grae->SetPointError(21,0,0,0,0);
   grae->SetPoint(22,2.3,9653.494);
   grae->SetPointError(22,0,0,0,0);
   grae->SetPoint(23,2.2,6013.781);
   grae->SetPointError(23,0,0,0,0);
   grae->SetPoint(24,2.1,3945.66);
   grae->SetPointError(24,0,0,0,0);
   grae->SetPoint(25,2,2470.862);
   grae->SetPointError(25,0,0,0,0);
   grae->SetPoint(26,1.9,1625.117);
   grae->SetPointError(26,0,0,0,0);
   grae->SetPoint(27,1.8,1003.212);
   grae->SetPointError(27,0,0,0,0);
   grae->SetPoint(28,1.7,664.6734);
   grae->SetPointError(28,0,0,0,0);
   grae->SetPoint(29,1.6,426.2942);
   grae->SetPointError(29,0,0,0,0);
   grae->SetPoint(30,1.5,289.8163);
   grae->SetPointError(30,0,0,0,0);
   grae->SetPoint(31,1.4,168.418);
   grae->SetPointError(31,0,0,0,0);
   grae->SetPoint(32,1.3,113.1446);
   grae->SetPointError(32,0,0,0,0);
   grae->SetPoint(33,1.2,72.49719);
   grae->SetPointError(33,0,0,0,0);
   grae->SetPoint(34,1.1,43.2109);
   grae->SetPointError(34,0,0,0,0);
   grae->SetPoint(35,1,25.55082);
   grae->SetPointError(35,0,0,0,0);
   grae->SetPoint(36,0.9,15.76466);
   grae->SetPointError(36,0,0,0,0);
   grae->SetPoint(37,0.8,8.669105);
   grae->SetPointError(37,0,0,0,0);
   grae->SetPoint(38,0.7,4.722695);
   grae->SetPointError(38,0,0,0,0);
   grae->SetPoint(39,0.6,2.438714);
   grae->SetPointError(39,0,0,0,0);
   
   TH1F *Graph_Limit68CLs6 = new TH1F("Graph_Limit68CLs6","Graph",100,0.41,2.69);
   Graph_Limit68CLs6->SetMinimum(1.09254);
   Graph_Limit68CLs6->SetMaximum(23174.55);
   ...
   Graph_LimitExpectedCLs7->SetMinimum(1.521606);
   Graph_LimitExpectedCLs7->SetMaximum(11515.46);
   ...
   Graph_LimitObservedCLs8->SetMinimum(2.004411);
   Graph_LimitObservedCLs8->SetMaximum(21980.85);
